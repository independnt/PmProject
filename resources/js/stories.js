$(document).ready(function() {
  let index = 1
  let stories_arr = [`I never cease exploring, or learning. It brought me to studying programming! This gave me the technical aptitude to build small applications and pages, like this one! So i understand what it takes to build, describe and test them.`,
    ...
    "I'm genuinely excited about Digital Surgeons. It's where I want to be, it's where I want to learn, and where I want to contribute."]
